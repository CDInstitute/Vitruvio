...
# Intialize training
npoints = 1000
optimizer = optim.Adam(model.parameters(), lr=1e-4, weight_decay=2 ) #TODO added weight decay
# optimizer = optim.SGD(model.parameters(), lr=1e-4, momentum=0.9)
trainer = config.get_trainer(model, optimizer, cfg, device=device)

checkpoint_io = CheckpointIO(out_dir, model=model, optimizer=optimizer)
try:
    load_dict = checkpoint_io.load('model.pt') # onet_img2mesh LOAD THE MODEL TODO ALBERTO model.pt / or best_model.pt
    print(load_dict)
